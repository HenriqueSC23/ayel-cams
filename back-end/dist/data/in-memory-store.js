...
function updatePreferences(user, partialPreferences) {
    user.preferences = {
        ...user.preferences,
        ...partialPreferences,
    };
...
export function updateUserByAdmin(userId, input) {
...
export function updateOwnUserProfile(userId, input) {
    return updateUserByAdmin(userId, input);
}
export function changeOwnUserPassword(userId, currentPassword, newPassword) {
    const user = findUserById(userId);
    if (!user) {
...
export function removeUserByAdmin(userId) {
...
export function updateCameraByAdmin(cameraId, input) {
...
export function removeCameraByAdmin(cameraId) {
...
export function touchUserAccess(userId) {
    const user = findUserById(userId);
    if (!user) {
        return;
    }
